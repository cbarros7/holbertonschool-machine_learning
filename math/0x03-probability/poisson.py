...
class Poisson():
    def __init__(self, data=None, lambtha=1.):
        ...
        Args:
            data: List of the data to be used to estimate the distribution. Defaults to None.
            lambtha :  List of the data to be used to estimate the distribution. Defaults to 1..
        """
