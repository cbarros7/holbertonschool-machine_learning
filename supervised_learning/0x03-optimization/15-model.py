...
def model(Data_train, Data_valid, layers, activations, alpha=0.001,
    ...
    """model: builds, trains, and saves a neural network model in tensorflow
    ...
    Args:
        ...
        decay_rate : is the decay rate for inverse time decay of
                    the learning rate (the corresponding
                    decay step should be 1)
        batch_size : is the number of data points that should be
                    in a mini-batch
